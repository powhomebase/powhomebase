...
#if defined(CONFIG_RTX_EVENT_RECORDER)
...
#define OS_IDLE_THREAD_STACK_SIZE   CONFIG_THREAD_IDLE_STACK_SIZE
#endif
...
#define OS_MEMPOOL_DATA_SIZE        128
#endif
...
#define OS_MSGQUEUE_DATA_SIZE       48
#endif
...
#define OS_EVR_MEMORY_LEVEL         0x00U
#endif
...
#define OS_EVR_KERNEL_LEVEL         0x00U
#endif
...
#define OS_EVR_THREAD_LEVEL         0x00U
#endif
...
#define OS_EVR_WAIT_LEVEL           0x00U
#endif
...
#define OS_EVR_THFLAGS_LEVEL        0x00U
#endif
...
#define OS_EVR_EVFLAGS_LEVEL        0x00U
#endif
...
#define OS_EVR_TIMER_LEVEL          0x00U
#endif
...
#define OS_EVR_MUTEX_LEVEL          0x00U
#endif
...
#define OS_EVR_SEMAPHORE_LEVEL      0x00U
#endif
...
#define OS_EVR_MEMPOOL_LEVEL        0x00U
#endif
...
#define OS_EVR_MSGQUEUE_LEVEL       0x00U
#endif
