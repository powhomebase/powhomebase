...
int32_t          driver_flash_Initialize(ARM_Flash_SignalEvent_t cb_event);
int32_t          driver_flash_Uninitialize(void);
int32_t          driver_flash_PowerControl(ARM_POWER_STATE state);
int32_t          driver_flash_ReadData(uint32_t addr, void *data, uint32_t cnt);
int32_t          driver_flash_ProgramData(uint32_t addr, const void *data, uint32_t cnt);
int32_t          driver_flash_EraseSector(uint32_t addr);
int32_t          driver_flash_EraseChip(void);
ARM_FLASH_STATUS driver_flash_GetStatus(void);
ARM_FLASH_INFO * driver_flash_GetInfo(void);
